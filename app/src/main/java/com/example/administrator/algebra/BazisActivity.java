...
public class BazisActivity extends AppCompatActivity {
...
//                }
    ...
    public void calculate(){
        ...
        if (coorCount != vecCount) {
            Toast.makeText(this, "Вектора не являются базисом", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void Solution(double[][] matr) {
        ...
        if (proverka(matr,n) && coorCount == vecCount) {
            Toast.makeText(this, "Система векторов является базисом", Toast.LENGTH_LONG).show();
        } else Toast.makeText(this, "Система векторов не является базисом", Toast.LENGTH_LONG).show();
    }
}
