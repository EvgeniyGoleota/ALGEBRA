...
public class TranspositionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Fragment fragA = getFragmentManager().findFragmentById(R.id.fragmentsCont);
        ...
        createButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                matrixSizeRow      = (EditText) findViewById(R.id.transMatrixSizeRow);
                matrixSizeColumn   = (EditText) findViewById(R.id.transMatrixSizeColumn);
                ...
                switch (sizeRow) {
                    case 2: {
                        switch (sizeColumn) {
                            ...
                            break;
                            case 3: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_2_3());
                            }
                            break;
                            case 4: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_2_4());
                            }
                            break;
                            case 5: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_2_5());
                            }
                            break;
                        }
                    }
                    ...
                    case 3: {
                        switch (sizeColumn) {
                            case 2: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_3_2());
                            }
                            break;
                            case 3: {
                            ...
                            break;
                            case 4: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_3_4());
                            }
                            break;
                            case 5: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_3_5());
                            }
                            break;
                        }
                    }
                    ...
                    case 4: {
                        switch (sizeColumn) {
                            case 2: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_4_2());
                            }
                            break;
                            case 3: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_4_3());
                            }
                            break;
                            case 4: {
                            ...
                            break;
                            case 5: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_4_5());
                            }
                            break;
                        }
                    }
                    ...
                    case 5: {
                        switch (sizeColumn) {
                            case 2: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_5_2());
                            }
                            break;
                            case 3: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_5_3());
                            }
                            break;
                            case 4: {
                                ftran.add(R.id.fragmentsCont, new Fragment_matrix_5_4());
                            }
                            break;
                            case 5: {
    ...
    private void Transposition() {
        Matrix.rectangleAnswerMatrix = new double[sizeColumn][sizeRow];
        for(int i=0;i<sizeRow;i++)
            for(int j=0;j<sizeColumn;j++){
                Matrix.rectangleAnswerMatrix[j][i] = Matrix.rectangleMatrixA[i][j];
            }
        Variables.sizeRow = sizeColumn;
        Variables.sizeColumn = sizeRow;
    }
